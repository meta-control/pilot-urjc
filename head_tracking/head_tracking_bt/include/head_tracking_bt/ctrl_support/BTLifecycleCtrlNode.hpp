...
#ifndef HEAD_TRACKING_BT__CTRL_SUPPORT__BTLIFECYCLECTRLNODE_HPP_
#define HEAD_TRACKING_BT__CTRL_SUPPORT__BTLIFECYCLECTRLNODE_HPP_
...
public:
  ...
  {
    node_ = rclcpp::Node::make_shared(xml_tag_name);
  }
  ...
  bool set_state(uint8_t state)
  {
    ...
    if (!result.get()->success) {
      ...
      RCLCPP_DEBUG(node_->get_logger(), "Transition success  %zu -> %zu", ctrl_node_state_, state);
    }
...
#endif  // HEAD_TRACKING_BT__CTRL_SUPPORT__BTLIFECYCLECTRLNODE_HPP_
